...
import { Moon, Sun, User, Heart, ShoppingBag, Menu, X } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <Link href="/" className="flex flex-col justify-center focus:outline-none group">
                ...
                <span className="text-[8px] md:text-[9px] font-semibold tracking-widest text-neutral-400 uppercase leading-none mt-0.5">
                  Fresh <span className="text-neutral-500 font-normal mx-0.5">•</span> Trusted
                </span>
              </Link>
            </div>
            ...
            <div className="flex items-center gap-1.5 md:gap-2">
              ...
              >
                ...
                <span className="absolute top-1.5 right-1.5 h-1.5 w-1.5 rounded-full bg-white border border-[#121214]" />
              </Link>
